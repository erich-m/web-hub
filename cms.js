  ...
  skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "TensorFlow", level: "expert", order: 2 },
        { name: "OpenCV", level: "expert", order: 3 },
        { name: "Scikit-learn", level: "expert", order: 4 },
        { name: "NumPy", level: "expert", order: 5 },
        { name: "Pandas", level: "expert", order: 6 },
        { name: "Matplotlib", level: "advanced", order: 7 },
        { name: "Tkinter", level: "advanced", order: 8 },
        { name: "YOLO", level: "advanced", order: 9 }
      ]
    },
    {
      id: "tools",
